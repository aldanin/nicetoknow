<script lang="js">
    ...
    import methods from './SvelteAgGridMethods.ts';
    ...
    let finalGridOptions=methods.setGridOptions(componentContext, gridOptions, colDefs);
    ...
    $: {
        console.log('componentContext.api1')
...
<div class="container">
    <div bind:this={gridDiv} class="grid-div {theme}" ></div>
</div>
